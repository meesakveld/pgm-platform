import { Blog, Error, Home, Opleiding, Portfolio, Services, Team, Search, ArticlePage } from "./pages";
...
const routes = createBrowserRouter(createRoutesFromElements(
	<Route path='/' element={<Root />} errorElement={<Error />}>
		...
		<Route path={ROUTES.blogDetail.path} element={<ArticlePage />} />
		<Route path={ROUTES.portfolio.path} element={<Portfolio />} />
		<Route path={ROUTES.portfolioDetail.path} element={<ArticlePage />} />
		<Route path={ROUTES.services.path} element={<Services />} />
		<Route path={ROUTES.servicesDetail.path} element={<ArticlePage />} />
